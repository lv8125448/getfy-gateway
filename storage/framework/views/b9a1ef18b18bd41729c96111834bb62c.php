...
<head>
    ...
    <title><?php echo e($branding['app_name'] ?? config('app.name')); ?></title>
</head>
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
                    <tr>
                        <td style="padding:0;background-color:<?php echo e($branding['theme_primary'] ?? '#4f46e5'); ?>;height:4px;"></td>
                    </tr>
                    <tr>
                        <td style="padding:28px 32px 8px 32px;text-align:center;">
                            <?php if(!empty($branding['logo_url'])): ?>
                                <img src="<?php echo e($branding['logo_url']); ?>" alt="<?php echo e($branding['app_name']); ?>" width="180" style="max-width:180px;height:auto;display:block;margin:0 auto 16px auto;border:0;">
                            <?php else: ?>
                                <p style="margin:0 0 8px 0;font-size:20px;font-weight:700;color:#18181b;letter-spacing:-0.02em;"><?php echo e($branding['app_name']); ?></p>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:20px 32px;background-color:#fafafa;border-top:1px solid #e4e4e7;">
                            <p style="margin:0;font-size:12px;line-height:1.5;color:#71717a;text-align:center;">
                                <?php echo e($branding['app_name'] ?? config('app.name')); ?>
...
<?php /**PATH C:\laragon\www\getfy-gateway\resources\views/emails/layouts/branded.blade.php ENDPATH**/ ?>