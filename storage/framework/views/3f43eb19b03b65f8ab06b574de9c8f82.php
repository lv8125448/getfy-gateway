...
<img src="<?php echo new \Illuminate\Support\EncodedHtmlString($logoUrl); ?>" alt="<?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name')); ?>" style="max-width: 200px; margin-bottom: 1.5rem; display: block;">
...
Se você está com problemas para clicar no botão "<?php echo new \Illuminate\Support\EncodedHtmlString($actionText); ?>", copie e cole o link abaixo no seu navegador: <span class="break-all">[<?php echo new \Illuminate\Support\EncodedHtmlString($displayableActionUrl); ?>](<?php echo new \Illuminate\Support\EncodedHtmlString($actionUrl); ?>)</span>
 <?php $__env->endSlot(); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\getfy-gateway\resources\views/vendor/notifications/email.blade.php ENDPATH**/ ?>