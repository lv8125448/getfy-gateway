...
async function previewRecipients() {
    ...
    try {
        const res = await axios.post(
            '/plataforma/email-marketing/preview-recipients',
...
<template>
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <form class="space-y-6 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800/50" @submit.prevent="form.post('/plataforma/email-marketing')">
            <div>
